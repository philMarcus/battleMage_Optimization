...
public class Optimizer_Phase_Three {
	...
	public static void runChallenge() {
		...
		for(int i=0;i<100;i++) {
			...
			new Battle(player1,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player2,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player3,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player4,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player6,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player7,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player8,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player9,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player10,level).doBattle(false,false);
			// -----------------------------------------

			// ==================================================
			// Mining Phase 1 Refined (Levels 10-20)...
			// ==================================================
			...
			new Battle(player11,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player12,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player13,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player14,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player15,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player16,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player17,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player18,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player19,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player20,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player20_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player20_5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player21_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player21_5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player22_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player22_5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player23_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player23_5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player24_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player24_5,level).doBattle(false,false);
			// -----------------------------------------

			// ==================================================
			// Mining Phase 2 Refined (Levels 24.5-26.1)...
			// ==================================================
			...
			new Battle(player24_6,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player24_7,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player24_8,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player24_9,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_1,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_2,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_3,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_4,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_5,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_6,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_7,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_8,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player25_9,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player26_0,level).doBattle(false,false);
			// -----------------------------------------
			...
			new Battle(player26_1,level).doBattle(false,false);
			// -----------------------------------------
		...
		try {
			...
			if (isTurnFileNew) {
				turnLogWriter.println("battleId,botName,level,turnNum,playerHpStart,playerStaminaStart,"
						...
						+ "totalThreat,actionName,actionDetail,playerHpEnd,oppHpEnd");
