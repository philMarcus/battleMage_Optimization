...
The core of the project is a large, multi-phase simulation whose results are analyzed in a single [***Jupyter notebook***](/01_Optimizing_battleMage.ipynb). Most readers should start there.
...
[***01_Optimizing_battleMage.ipynb***](/01_Optimizing_battleMage.ipynb)
